...
./shp2ncmask.py -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -lc ## --list--columns
./shp2ncmask.py -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -dc NAME_1 ## --describe-column
./shp2ncmask.py -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -s NAME_1 'Île-de-France' -b
./shp2ncmask.py -m weight -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -s NAME_1 'Île-de-France' -g 1.4,3.6,0.05,48.1,49.3,0.05 -o data/mask_IDF_4326.nc -fig figures/control_IDF_4326.png -fepsg 4326

## The last is also the IDF, but in LambertII coordinates, so we change the input epsg to find the bounds
./shp2ncmask.py -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -s NAME_1 'Île-de-France' -iepsg 27572 -b
./shp2ncmask.py -m weight -i data/gadm36_FRA_shp/gadm36_FRA_1.shp -s NAME_1 'Île-de-France' -g 534000,700000,8000,2340000,2480000,8000 -o data/mask_IDF_27572.nc -oepsg 27572 -fig figures/control_IDF_27572_8km.png -fepsg 4326
